...
import eu.xenit.gradle.alfresco.tasks.InjectFilesInWarTask;
import eu.xenit.gradle.alfresco.tasks.InstallAmpsInWarTask;
import eu.xenit.gradle.alfresco.tasks.MergeWarsTask;
import eu.xenit.gradle.alfresco.tasks.StripAlfrescoWarTask;
import eu.xenit.gradle.alfresco.tasks.WarEnrichmentTask;
import eu.xenit.gradle.alfresco.tasks.WarLabelOutputTask;
